...
Public Class frmExpected_Arrival_List

    Private Sub frmExpected_Arrival_List_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            'fltString = ""
            fltString = "{rpt_Expected_Arrival_Departures_View.ResDate} >=#" & dtResDate.Text & "# and {rpt_Expected_Arrival_Departures_View.ResDate} <=#" & dtResDate2.Text & "# "
