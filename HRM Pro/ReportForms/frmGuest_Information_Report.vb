...
Public Class frmGuest_Information_Report
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            dcIns = New SqlCommand("select * from rpt_Guest_Information_Report_View", Conn)
            ...
            fltString = ""
            ' fltString = "{rpt_Guest_Information_Report_View.ResDate} >=#" & dtResDate.Text & "# and {rpt_Guest_Information_Report_View.ResDate}<=#" & dtResDate2.Text & "# "


            ReportName = "Guest_Information_Report.rpt"
            rptTitle = "Guest_Information_Report"
