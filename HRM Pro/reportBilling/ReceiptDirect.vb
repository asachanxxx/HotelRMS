...
Public Class ReceiptDirect
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRM_Pro.ReceiptDirect.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReceiptDirect
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReceiptDirect = New ReceiptDirect()
        rpt.Site = Me.Site
        Return rpt
    End Function
