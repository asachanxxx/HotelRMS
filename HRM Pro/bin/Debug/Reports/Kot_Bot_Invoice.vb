...
Public Class Kot_Bot_Invoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRM_Pro.Kot_Bot_Invoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKot_Bot_Invoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Kot_Bot_Invoice = New Kot_Bot_Invoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
